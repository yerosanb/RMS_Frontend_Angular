...
@Component({
  selector: 'app-view-core-stock-deleted',
  templateUrl: './view-core-stock-deleted.component.html',
  styleUrls: ['./view-core-stock-deleted.component.css']
})
export class ViewCoreStockDeletedComponent implements OnInit, AfterViewInit {
  //Swal Config
  ...
  core_sixth_column_title = 'Value date';
  ...
  ngOnInit(): void {
    ...
    this.detailModal = new window.bootstrap.Modal(
      document.getElementById('details_transaction_modal_stock_core')
    );
    this.dtOptions = {
      serverSide: false,
      scrollX: true,
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.stockService.getDeleteStockCoreTransaction().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
    ...
    this.dtOptions_detail = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.stockService.getEditedDetailStockCoreTransaction(that.idd).subscribe(
          async (resp: any) => {
                ...
                this.utilService.refreshToken().subscribe(
                  (data) => {
                    if (data === true) {
                      ...
                      //================================================================================
                      this.stockService
                        .getEditedDetailStockCoreTransaction(that.idd).subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
