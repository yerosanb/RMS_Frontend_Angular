  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_mms_stock = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.stockService
            .getStockMMSForView(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US'),this.type)
            .subscribe(
              async (resp: any) => {
                console.log(
    ...
    try {
      this.dtOptions_core_stock = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.stockService.getStockCoreForView(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US'),this.type).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
