...
@Component({
  selector: 'app-view-approved-reject-user',
  templateUrl: './view-approved-reject-user.component.html',
  styleUrls: ['./view-approved-reject-user.component.css']
})
export class ViewApprovedRejectUserComponent   implements OnInit, AfterViewInit, OnDestroy {
  dtOptions: any;
  // min!: number;
  // max!: number;
  //Swal Config
  ...
  ngOnInit(): void {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.adminService.getApprovedRejectedUser().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
      ...
      columns: [
        ...
        },
        {
          ...
          render: function (data: any, type: any, full: any) {
            ...
            if (full.status == 0)
              return '<span class="badge bg-warning rounded-pill">Rejected</span>';
