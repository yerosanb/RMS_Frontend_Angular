...
import { ReceivableServiceService } from '../../../receivable/recon-receivable/service/receivable-service.service';
import { IssueAccountService } from '../../services/issue-account.service';
@Component({
  selector: 'app-matched-reason',
  templateUrl: './matched-reason.component.html',
  styleUrls: ['./matched-reason.component.css']
})
export class MatchedReasonComponent   implements OnInit {
  ...
  dtOptions_receivable_credit_match_reason: any;
  dtOptions_receivable_debit_match_reason: any;
  //core inits
  ...
  core_qbs_sixth_column_title = 'Branch Name';
 ...
 // core_ninth_column_id = '8';
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_receivable_credit_match_reason = {
        serverSide: false,
        scrollX: true,
        searching: true,
        // lengthMenu: 'ten',
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.issueAccountService.getAllIssueCoreMatchWithReason().subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
        ...
        columns: [
          ...
          {
            title: this.core_qbs_sixth_column_title,
            data: 'branch_code',
          },
          {
    ...
    try {
      this.dtOptions_receivable_debit_match_reason = {
        serverSide: false,
        scrollX: true,
        searching: true,
        // lengthMenu: 'ten',
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.issueAccountService.getAllIssueQBSMatchWithReason().subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
