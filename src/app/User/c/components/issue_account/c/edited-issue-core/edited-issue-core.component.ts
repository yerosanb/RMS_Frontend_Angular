...
@Component({
  selector: 'app-edited-issue-core',
  templateUrl: './edited-issue-core.component.html',
  styleUrls: ['./edited-issue-core.component.css']
})
export class EditedIssueCoreComponent implements OnInit, AfterViewInit {
  //Swal Config
  ...
  ngOnInit(): void {
    ...
    this.detailModal = new window.bootstrap.Modal(
      document.getElementById('details_transaction_modal_issue_core')
    );
    this.dtOptions = {
      serverSide: false,
      scrollX: true,
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.issueAccountService.getEditeIssueCoreTransaction().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
    ...
    this.dtOptions_detail = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.issueAccountService.getEditedDetailIssueCoreTransaction(that.idd).subscribe(
          async (resp: any) => {
                  ...
                  (data) => {
                    if (data === true) {
                      ...
                      this.issueAccountService
                        .getEditedDetailIssueCoreTransaction(that.idd).subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
