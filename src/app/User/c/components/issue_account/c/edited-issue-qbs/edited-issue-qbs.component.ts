...
@Component({
  selector: 'app-edited-issue-qbs',
  templateUrl: './edited-issue-qbs.component.html',
  styleUrls: ['./edited-issue-qbs.component.css']
})
export class EditedIssueQbsComponent implements OnInit, AfterViewInit {
  //Swal Config
  ...
  ngOnInit(): void {
    ...
    this.detailModal = new window.bootstrap.Modal(
      document.getElementById('details_transaction_modal_issue_qbs')
    );
    this.dtOptions = {
      serverSide: false,
      scrollX: true,
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.issueAccountService.getEditeIssueQBSTransaction().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
    ...
    this.dtOptions_detail = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.issueAccountService.getEditedDetailIssueQBSTransaction(that.idd).subscribe(
          async (resp: any) => {
                  ...
                  (data) => {
                    if (data === true) {
                      ...
                      this.issueAccountService
                        .getEditedDetailIssueQBSTransaction(that.idd).subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
