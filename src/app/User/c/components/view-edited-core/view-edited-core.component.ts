...
@Component({
  selector: 'app-view-edited-core',
  templateUrl: './view-edited-core.component.html',
  styleUrls: ['./view-edited-core.component.css']
})
export class ViewEditedCoreComponent implements OnInit, AfterViewInit {
  //Swal Config
  ...
  ngOnInit(): void {
    ...
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.reconcileService.getEditedCoreTransaction().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
                  ...
                  (data) => {
                    if (data === true) {
                      ...
                      this.reconcileService
                        .getEditedCoreTransaction().subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
    ...
    this.dtOptions_detail = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.reconcileService.getEditedDetailCoreTransaction(that.idd).subscribe(
          async (resp: any) => {
                ...
                this.utilService.refreshToken().subscribe(
                  (data) => {
                    if (data === true) {
                      ...
                      //================================================================================
                      this.reconcileService
                        .getEditedDetailCoreTransaction(that.idd).subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
