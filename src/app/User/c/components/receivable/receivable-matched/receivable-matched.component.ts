...
@Component({
  selector: 'app-receivable-matched',
  templateUrl: './receivable-matched.component.html',
  styleUrls: ['./receivable-matched.component.css']
})
export class ReceivableMatchedComponent implements OnInit {
  ...
  dtOptions_receivable_credit: any;
  dtOptions_receivable_debit: any;
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_receivable_credit = {
        serverSide: false,
        scrollX: true,
        searching: true,
        // lengthMenu: 'ten',
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.receivableService.getReceivableCreditMatched(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
    ...
    try {
      this.dtOptions_receivable_debit = {
        serverSide: false,
        scrollX: true,
        searching: true,
        // lengthMenu: 'ten',
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.receivableService.getPayableDebitMatched(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
              ...
              Swal.fire({
                ...
                if (result.isConfirmed) {
                  ...
                  this.receivableService
                    .unmatchReceivableTransactions(data_1_id.toString(), data_2_id.toString())
                    .subscribe(
                      (data: any) => {
                        if (data == true) {
