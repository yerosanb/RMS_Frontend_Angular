...
@Component({
  selector: 'app-view-match-with-reason',
  templateUrl: './view-match-with-reason.component.html',
  styleUrls: ['./view-match-with-reason.component.css']
})
export class ViewMatchWithReasonComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_receivable_credit_match_reason = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.receivableService.getAllReceivableCreditMatchWithReason().subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
    ...
    try {
      this.dtOptions_receivable_debit_match_reason = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.receivableService.getAllReceivableDebitMatchWithReason().subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
