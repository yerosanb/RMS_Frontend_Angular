...
@Component({
  selector: 'app-receivable-manual',
  templateUrl: './receivable-manual.component.html',
  styleUrls: ['./receivable-manual.component.css']
})
export class ReceivableManualComponent implements OnInit {
        ...
        (dtElement: DataTableDirective, index: number) => {
          if (index == 0) {
            ...
            dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
              ...
              else if(data_1_id.length > 1 || data_2_id.length > 1)
              {
