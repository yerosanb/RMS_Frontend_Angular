...
@Component({
  selector: 'app-rejected-currencies',
  templateUrl: './rejected-currencies.component.html',
  styleUrls: ['./rejected-currencies.component.css']
})
export class RejectedCurrenciesComponent implements OnInit, AfterViewInit, OnDestroy
{
