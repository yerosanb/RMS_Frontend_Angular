...
@Component({
  selector: 'app-approved-currencies',
  templateUrl: './approved-currencies.component.html',
  styleUrls: ['./approved-currencies.component.css']
})
export class ApprovedCurrenciesComponent implements OnInit, AfterViewInit, OnDestroy
{
  ...
  ngOnInit(): void {
    ...
    this.dtOption1 = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.service.fetchApprovedCurrency().subscribe((resp) => {
