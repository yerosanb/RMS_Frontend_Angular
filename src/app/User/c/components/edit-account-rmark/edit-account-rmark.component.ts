...
// import { UpdateRemarkPayload } from 'src/app/User/c/components/update-remark-payload';
// import { RemarkPayload } from 'src/app/User/c/components/remark-payload';

@Component({
  selector: 'app-edit-account-rmark',
  templateUrl: './edit-account-rmark.component.html',
  styleUrls: ['./edit-account-rmark.component.css'],
})
export class EditAccountRmarkComponent {
  //Swal Config
