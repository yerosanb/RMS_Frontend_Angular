...
@Component({
  selector: 'app-view-sos-matched',
  templateUrl: './view-sos-matched.component.html',
  styleUrls: ['./view-sos-matched.component.css'],
})
export class ViewSosMatchedComponent {
