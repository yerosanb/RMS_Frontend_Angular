...
@Component({
  selector: 'app-view-all-unmatched',
  templateUrl: './view-all-unmatched.component.html',
  styleUrls: ['./view-all-unmatched.component.css']
})
export class ViewAllUnmatchedComponent {
  //Swal Config
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_ats = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconViewService.getAllAtsUnmatchedForView(
    ...
    try {
      this.dtOptions_core = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconViewService.getAllCoreUnmatchedForView(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
