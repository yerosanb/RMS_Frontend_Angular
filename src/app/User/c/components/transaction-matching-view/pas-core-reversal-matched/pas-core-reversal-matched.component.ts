...
@Component({
  selector: 'app-pas-core-reversal-matched',
  templateUrl: './pas-core-reversal-matched.component.html',
  styleUrls: ['./pas-core-reversal-matched.component.css']
})
export class PasCoreReversalMatchedComponent {
        ...
        dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
          ...
          for (let i = 0; i < rowData.length; i++) {
            ...
            if (rowData[i].dr_cr.toLowerCase().startsWith('cr'))
              match_id_core =Number(match_id_core.toFixed(2))+ Number(
