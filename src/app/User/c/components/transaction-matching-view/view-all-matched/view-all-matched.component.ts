...
@Component({
  selector: 'app-view-all-matched',
  templateUrl: './view-all-matched.component.html',
  styleUrls: ['./view-all-matched.component.css']
})
export class ViewAllMatchedComponent {
  ...
  ngOnInit(): void {
      ...
      this.dtOptions_ats = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconViewService
            .getAllAtsForView(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US'))
            .subscribe(
              async (resp: any) => {
                console.log(
    ...
    try {
      this.dtOptions_core = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconViewService.getAllCoreForView(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
