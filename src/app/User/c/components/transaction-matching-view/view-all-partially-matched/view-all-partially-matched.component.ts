...
@Component({
  selector: 'app-view-all-partially-matched',
  templateUrl: './view-all-partially-matched.component.html',
  styleUrls: ['./view-all-partially-matched.component.css'],
})
export class ViewAllPartiallyMatchedComponent {
  ...
  ats_thirteenth_column_title = 'amount Difference';
  ats_fourteenth_column_title = 'Reason';
  ats_input_0!: any;
  ats_input_1!: any;
  ats_input_2!: any;
  ats_input_3!: any;
  ...
  core_thirteenth_column_title = 'amount Difference';
  core_fourteenth_column_title = 'Reason';
  core_input_0!: any;
  core_input_1!: any;
  core_input_2!: any;
  core_input_3!: any;
  ...
  ats_tweleeveth_column_title: any;
  core_tweleeveth_column_title: any;
    ...
    try {
      this.dtOptions_ats = {
        ...
        columns: [
          ...
          {
            title: this.ats_fourteenth_column_title,
            data: 'description',
          },
          // {
          //   title: this.ats_tenth_column_title,
              ...
              (dtElement: DataTableDirective, index: number) => {
                ...
                if (index == 0) {
                  ...
                  dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
                    ...
                    console.log(
                      'selectionsssssssssssssssyyyyyyyyyy: ' +
                        that.filteredCoreData
                    );
                  });
          ...
          dtInstance.on(
            ...
            function (e, settings, details) {
              ...
              for (let col of settings.aoColumns) {
                ...
                }else if (col.title == that.ats_eleventh_column_title) {
                  that.ats_eleventh_column_title = c.toString();
                }else if (col.title == that.ats_tweleeveth_column_title) {
                  that.ats_tweleeveth_column_title = c.toString();
                }else if (col.title == that.ats_thirteenth_column_title) {
                  that.ats_thirteenth_column_title = c.toString();
                }else if (col.title == that.ats_fourteenth_column_id) {
                  that.ats_fourteenth_column_id = c.toString();
                }
                c++;
              }
            }
          ...
          dtInstance.on('column-reorder', function (e, settings, details) {
            ...
            for (let col of settings.aoColumns) {
              if (col.title == that.ats_first_column_title) {
                ...
                that.ats_eleventh_column_id = c.toString();
              }else if (col.title == that.ats_tweleeveth_column_title) {
                that.ats_tewelfth_column_id = c.toString();
              }else if (col.title == that.ats_thirteenth_column_title) {
                that.ats_thirteenth_column_id = c.toString();
              }else if (col.title == that.ats_fourteenth_column_id) {
                that.ats_fourteenth_column_id = c.toString();
              }
              c++;
          ...
          dtInstance.on(
            ...
            function (e, settings, details) {
              ...
              for (let col of settings.aoColumns) {
                ...
                }else if (col.title == that.core_tweleeveth_column_title) {
                  that.ats_tewelfth_column_id = c.toString();
                }else if (col.title == that.core_thirteenth_column_title) {
                  that.core_thirteenth_column_id = c.toString();
      ...
      if (index == 0) {
        ...
        dtElement.dtInstance.then((dtInstance: DataTables.Api) => {
          ...
          if (this.selections > 0) {
            if (
              this.filteredAtsData == this.selectedAtsData &&
              this.filteredCoreData == this.selectedCoreData
            ) {
