...
@Component({
  selector: 'app-view-edited-nbe',
  templateUrl: './view-edited-nbe.component.html',
  styleUrls: ['./view-edited-nbe.component.css']
})
export class ViewEditedNBEComponent implements OnInit, AfterViewInit {
  //Swal Config
  ...
  ngOnInit(): void {
    ...
    this.detailModal = new window.bootstrap.Modal(
      document.getElementById('detail_transaction_modal')
    );
    this.dtOptions = {
      serverSide: false,
      scrollX: true,
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.reconcileService.getEditedAtsTransaction().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
                  ...
                  (data) => {
                    if (data === true) {
                      ...
                      this.reconcileService
                        .getEditedAtsTransaction().subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
    ...
    this.dtOptions_detail = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.reconcileService.getEditedDetailAtsTransaction(that.idd).subscribe(
          async (resp: any) => {
            ...
            if (resp != null) {
              ...
              // console.log(
              //   'records amount==========>: ' + JSON.stringify(resp.amount)
              // );
            } else {
              Swal.fire({
                icon: 'error',
                ...
                this.utilService.refreshToken().subscribe(
                  (data) => {
                    if (data === true) {
                      ...
                      //================================================================================
                      this.reconcileService
                        .getEditedDetailAtsTransaction(that.idd).subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
