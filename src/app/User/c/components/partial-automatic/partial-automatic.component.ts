...
@Component({
  selector: 'app-partial-automatic',
  templateUrl: './partial-automatic.component.html',
  styleUrls: ['./partial-automatic.component.css'],
})
export class PartialAutomaticComponent implements OnInit {
  ...
  matchAllTransaction() {
    Swal.fire({
      text: 'You are matching all transactions automatically to partial. Are you sure? ',
      icon: 'warning',
