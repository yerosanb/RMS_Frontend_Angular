...
@Component({
  selector: 'app-payable-auto',
  templateUrl: './payable-auto.component.html',
  styleUrls: ['./payable-auto.component.css']
})
export class PayableAutoComponent  implements OnInit {
