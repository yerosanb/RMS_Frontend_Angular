...
@Component({
  selector: 'app-view-stocke-matched',
  templateUrl: './view-stocke-matched.component.html',
  styleUrls: ['./view-stocke-matched.component.css']
})
export class ViewStockeMatchedComponent {
