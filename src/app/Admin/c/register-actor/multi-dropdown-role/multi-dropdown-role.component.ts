...
@Component({
  selector: 'app-multi-dropdown-role',
  templateUrl: './multi-dropdown-role.component.html',
  styleUrls: ['./multi-dropdown-role.component.css'],
})
export class MultiDropdownRoleComponent implements OnInit {
