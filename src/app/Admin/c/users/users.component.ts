        ...
        },
        {
          ...
          render: function (data: any, type: any, full: any) {
            document
              ...
              ?.classList.remove('dt-button');
            return (
              '<i class="mdi mdi-18px mdi-pencil text-secondary" style="cursor: pointer;" edit-user="' +
              full.id +
              '"></i>' +
              ...
              full.id +
              '"></i>' +
              '<i class="mdi mdi-18px mdi-lock-reset text-dark" style="cursor: pointer; margin-left: 4px;" ' +
              'user-name="' +
              full.firstname +
              ' ' +
              full.lastname +
