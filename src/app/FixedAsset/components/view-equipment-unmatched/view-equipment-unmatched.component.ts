...
@Component({
  selector: 'app-view-equipment-unmatched',
  templateUrl: './view-equipment-unmatched.component.html',
  styleUrls: ['./view-equipment-unmatched.component.css']
})
export class ViewEquipmentUnmatchedComponent {
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.viewService.getEquipmentMMsUnmatchedForView(
    ...
    try {
      this.dtOptions_core = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.viewService.getEquipmentCoreUnmatchedForView(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
