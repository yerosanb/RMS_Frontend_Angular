...
@Component({
  selector: 'app-recon-automatic-furniture',
  templateUrl: './recon-automatic-furniture.component.html',
  styleUrls: ['./recon-automatic-furniture.component.css']
})
export class ReconAutomaticFurnitureComponent {
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService.getFixedMMSForReconAutoFurniture(
                      ...
                      (data) => {
                        if (data === true) {
                          ...
                          this.autoReconFixedService
                             .getFixedMMSForReconAutoFurniture(
                              formatDate(
                                this.initialDateValue,
                                'yyyy-MM-dd',
                                'en-US'
    ...
    try {
      this.dtOptions_core = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService
          .getFixedCoreForReconAutoFurniture(
              formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')
            )
            .subscribe(
              async (resp: any) => {
