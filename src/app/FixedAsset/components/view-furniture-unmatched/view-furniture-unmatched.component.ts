...
@Component({
  selector: 'app-view-furniture-unmatched',
  templateUrl: './view-furniture-unmatched.component.html',
  styleUrls: ['./view-furniture-unmatched.component.css']
})
export class ViewFurnitureUnmatchedComponent {
  //Swal Config
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.viewService.getFurnitureMMsUnmatchedForView(
    ...
    try {
      this.dtOptions_core = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.viewService.getFurnitureCoreUnmatchedForView(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
