...
@Component({
  selector: 'app-recon-automatic-equipment',
  templateUrl: './recon-automatic-equipment.component.html',
  styleUrls: ['./recon-automatic-equipment.component.css']
})
export class ReconAutomaticEquipmentComponent {
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService.getFixedMMSForReconAutoEquipment(
                      ...
                      (data) => {
                        if (data === true) {
                          ...
                          this.autoReconFixedService
                             .getFixedMMSForReconAutoEquipment(
                              formatDate(
                                this.initialDateValue,
                                'yyyy-MM-dd',
                                'en-US'
    ...
    try {
      this.dtOptions_core = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService
          .getFixedCoreForReconAutoEquipment(
              formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')
            )
            .subscribe(
              async (resp: any) => {
