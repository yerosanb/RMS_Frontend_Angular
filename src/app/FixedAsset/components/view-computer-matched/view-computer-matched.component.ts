...
@Component({
  selector: 'app-view-computer-matched',
  templateUrl: './view-computer-matched.component.html',
  styleUrls: ['./view-computer-matched.component.css']
})
export class ViewComputerMatchedComponent {
  ...
  ngOnInit(): void {
      ...
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService
            .getFixedMMSForViewComputer(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US'))
            .subscribe(
              async (resp: any) => {
                console.log(
    ...
    try {
      this.dtOptions_core = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService.getFixedCoreForViewComputer(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
