...
@Component({
  selector: 'app-recon-automatic-vehicle',
  templateUrl: './recon-automatic-vehicle.component.html',
  styleUrls: ['./recon-automatic-vehicle.component.css']
})
export class ReconAutomaticVehicleComponent {
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService.getFixedMMSForReconAutoVehicle(
                      ...
                      (data) => {
                        if (data === true) {
                          ...
                          this.autoReconFixedService
                             .getFixedMMSForReconAutoVehicle(
                              formatDate(
                                this.initialDateValue,
                                'yyyy-MM-dd',
                                'en-US'
    ...
    try {
      this.dtOptions_core = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService
          .getFixedCoreForReconAutoVehicle(
              formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')
            )
            .subscribe(
              async (resp: any) => {
