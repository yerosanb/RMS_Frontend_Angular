...
@Component({
  selector: 'app-recon-manual-computer',
  templateUrl: './recon-manual-computer.component.html',
  styleUrls: ['./recon-manual-computer.component.css']
})
export class ReconManualComputerComponent {
  ...
  ngOnInit(): void {
      ...
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconManualFixedAssetService
            .get_raw_fixed_mms_for_recon_computer(
    ...
    try {
      this.dtOptions_core = {
        ...
        select: true,
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconManualFixedAssetService.get_raw_fixed_core_for_recon_computer().subscribe(
            async (resp: any) => {
              if (resp != null) {
                callback({
                  recordsTotal: resp.recordsTotal,
