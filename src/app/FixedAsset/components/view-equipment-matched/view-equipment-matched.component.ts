...
@Component({
  selector: 'app-view-equipment-matched',
  templateUrl: './view-equipment-matched.component.html',
  styleUrls: ['./view-equipment-matched.component.css']
})
export class ViewEquipmentMatchedComponent {
  ...
  ngOnInit(): void {
      ...
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService
            .getFixedMMSForViewEquipment(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US'))
            .subscribe(
              async (resp: any) => {
                console.log(
    ...
    try {
      this.dtOptions_core = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.autoReconFixedService.getFixedCoreForViewEquipment(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
