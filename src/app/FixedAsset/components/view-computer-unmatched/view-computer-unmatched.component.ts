...
@Component({
  selector: 'app-view-computer-unmatched',
  templateUrl: './view-computer-unmatched.component.html',
  styleUrls: ['./view-computer-unmatched.component.css']
})
export class ViewComputerUnmatchedComponent {
  //Swal Config
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.viewService.getComputerMMsUnmatchedForView(
    ...
    try {
      this.dtOptions_core = {
        ...
        // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.viewService.getComputerCoreUnmatchedForView(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
