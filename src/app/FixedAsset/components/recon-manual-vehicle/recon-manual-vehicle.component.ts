...
@Component({
  selector: 'app-recon-manual-vehicle',
  templateUrl: './recon-manual-vehicle.component.html',
  styleUrls: ['./recon-manual-vehicle.component.css']
})
export class ReconManualVehicleComponent {
  ...
  ngOnInit(): void {
        ...
        rowCallback: (row: Node, data: any[] | Object, index: number) => {
         ...
         ajax: (dataTablesParameters: any, callback: any) => {
          this.reconManualFixedAssetService
            .get_raw_fixed_mms_for_recon_vehicle(
    ...
    try {
      this.dtOptions_core = {
        ...
        select: true,
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconManualFixedAssetService.get_raw_fixed_core_for_recon_vehicle().subscribe(
            async (resp: any) => {
              if (resp != null) {
                callback({
                  recordsTotal: resp.recordsTotal,
