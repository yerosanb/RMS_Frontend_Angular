...
@Component({
  selector: 'app-recon-manual-furniture',
  templateUrl: './recon-manual-furniture.component.html',
  styleUrls: ['./recon-manual-furniture.component.css']
})
export class ReconManualFurnitureComponent {
  ...
  ngOnInit(): void {
      ...
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconManualFixedAssetService
            .get_raw_fixed_mms_for_recon_furniture(
    ...
    try {
      this.dtOptions_core = {
        ...
        select: true,
        ajax: (dataTablesParameters: any, callback: any) => {
          this.reconManualFixedAssetService.get_raw_fixed_core_for_recon_furniture().subscribe(
            async (resp: any) => {
              if (resp != null) {
                callback({
                  recordsTotal: resp.recordsTotal,
