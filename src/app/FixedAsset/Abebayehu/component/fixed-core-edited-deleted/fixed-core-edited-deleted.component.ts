...
@Component({
  selector: 'app-fixed-core-edited-deleted',
  templateUrl: './fixed-core-edited-deleted.component.html',
  styleUrls: ['./fixed-core-edited-deleted.component.css']
})
export class FixedCoreEditedDeletedComponent implements OnInit, AfterViewInit {
  //Swal Config
  ...
  ngOnInit(): void {
    ...
    this.detailModal = new window.bootstrap.Modal(
      document.getElementById('details_transaction_modal_fixed_core')
    );
    this.dtOptions = {
      serverSide: false,
      scrollX: true,
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.reconService.getDeleteFixedCoreTransaction().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
    ...
    this.dtOptions_detail = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.reconService.getEditedDetailFixedCoreTransaction(that.idd).subscribe(
          async (resp: any) => {
                ...
                this.utilService.refreshToken().subscribe(
                  (data) => {
                    if (data === true) {
                      ...
                      //================================================================================
                      this.reconService
                        .getEditedDetailFixedCoreTransaction(that.idd).subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
