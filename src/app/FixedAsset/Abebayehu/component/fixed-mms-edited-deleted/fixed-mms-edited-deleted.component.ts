...
@Component({
  selector: 'app-fixed-mms-edited-deleted',
  templateUrl: './fixed-mms-edited-deleted.component.html',
  styleUrls: ['./fixed-mms-edited-deleted.component.css']
})
export class FixedMmsEditedDeletedComponent implements OnInit, AfterViewInit {
  //Swal Config
  ...
  core_third_column_title = 'Branch Code';
  core_fourth_column_title = 'Value Date';
  core_fifth_column_title = 'Debit';
  core_sixth_column_title = 'Credit';
  core_seventh_column_title = 'Naration';
  core_eighth_column_title = 'Upload Date';
  core_ninth_column_title = 'Account Name';
  ...
  ngOnInit(): void {
    ...
    this.detailModal = new window.bootstrap.Modal(
      document.getElementById('details_transaction_modal_fixed_mms')
    );
    this.dtOptions = {
      serverSide: false,
      scrollX: true,
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.reconService.getDeleteFixedMMSTransaction().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
    ...
    this.dtOptions_detail = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        this.reconService.getEditedDetailFixedMMSTransaction(that.idd).subscribe(
          async (resp: any) => {
                ...
                this.utilService.refreshToken().subscribe(
                  (data) => {
                    if (data === true) {
                      ...
                      //================================================================================
                      this.reconService
                        .getEditedDetailFixedMMSTransaction(that.idd).subscribe(
                          async (resp: any) => {
                            if (resp != null) {
                              console.log(
                                'response for table: ' +
