...
// @Component({
//   selector: 'app-fixed-recon-automatic',
//   templateUrl: './fixed-recon-automatic.component.html',
//   styleUrls: ['./fixed-recon-automatic.component.css']
// })
// export class FixedReconAutomaticComponent implements OnInit{
...
//           this.autoReconFixedService.getFixedMMSForReconAuto(
