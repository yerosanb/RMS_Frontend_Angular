...
@Component({
  selector: 'app-view-fixed-asset-with-reason',
  templateUrl: './view-fixed-asset-with-reason.component.html',
  styleUrls: ['./view-fixed-asset-with-reason.component.css'],
})
export class ViewFixedAssetWithReasonComponent {
  ...
  mms_seventeenth_column_title = 'Reason';
  mms_input_0!: any;
  mms_input_1!: any;
  mms_input_2!: any;
  mms_input_3!: any;
  ...
  core_sixteenth_column_title = 'Reason';
  ...
  core_seventeenth_column_id = '16';
  core_eighteenth_column_id = '17';
  ...
  constructor(
    ...
    private viewReasonService: ViewReasonService
  ) {}
  ...
  ngOnInit(): void {
    ...
    try {
      this.dtOptions_mms = {
        ...
        ajax: (dataTablesParameters: any, callback: any) => {
          this.viewReasonService
            .getFixedMMSForViewReason(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US'))
            .subscribe(
              async (resp: any) => {
                console.log(
                    ...
                    this.utilService.refreshToken().subscribe(
                      (data) => {
                        if (data === true) {
                          ...
                          this.viewReasonService.getFixedMMSForViewReason(
                              formatDate(
                                this.initialDateValue,
                                'yyyy-MM-dd',
                                'en-US'
    ...
    try {
      this.dtOptions_core = {
       ...
       // ajax: '../../../../assets/data/data.json',
        ajax: (dataTablesParameters: any, callback: any) => {
          this.viewReasonService.getFixedCoreForViewReason(formatDate(this.initialDateValue, 'yyyy-MM-dd', 'en-US')).subscribe(
            async (resp: any) => {
              if (resp != null) {
                console.log(
                  'response for table: ' + JSON.stringify(resp, null, 2)
