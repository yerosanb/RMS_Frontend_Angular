...
@Component({
  selector: 'app-view-currency-remark',
  templateUrl: './view-currency-remark.component.html',
  styleUrls: ['./view-currency-remark.component.css']
})
export class ViewCurrencyRemarkComponent implements OnInit, AfterViewInit {
  ...
  replay_request_modal_currency: any;
  ...
  ngOnInit(): void {
    this.replay_request_modal_currency = new window.bootstrap.Modal(
      document.getElementById('replay-modal-currency'),
    )
    this.dtOptions = {
      serverSide: false,
      scrollX: true,
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        ...
        //     {}
        //   )
        this.approverService.getCurrencyRemarks().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
      ...
      columns: [
...

        {
          ...
          render: function (data: any, type: any, full: any) {
            ...
            return (
              '<button class="btn btn-outline-warning btn-rounded" replay-currency-remark="' +
              full.id +
  ...
  saveRemark(remark_id: any, remark: Remark) {
    ...
    this.approverService.replayRemarkCurrency(remark_id, remark).subscribe(
      async (data) => {
        if (data == true) {
  ...
  closeModal() {
    this.replay_request_modal_currency.hide()
  }


  ngAfterViewInit(): void {
    this.renderer.listen('document', 'click', (event) => {
      if (event.target.hasAttribute('replay-currency-remark')) {
        var selected_request_id = event.target.getAttribute('replay-currency-remark');
        this.remark_id = selected_request_id
        this.replay_request_modal_currency.show();
