...
@Component({
  selector: 'app-send-currency-remark',
  templateUrl: './send-currency-remark.component.html',
  styleUrls: ['./send-currency-remark.component.css']
})
export class SendCurrencyRemarkComponent implements OnInit {
  //Swal Config
