...
@Component({
  selector: 'app-rejected-currency-requests',
  templateUrl: './rejected-currency-requests.component.html',
  styleUrls: ['./rejected-currency-requests.component.css']
})
export class RejectedCurrencyRequestsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        ...
        //     {}
        //   )
        this.approverService.getAllRejectedCurrencyRequests().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
