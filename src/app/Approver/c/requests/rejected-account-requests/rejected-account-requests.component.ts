...
@Component({
  selector: 'app-rejected-account-requests',
  templateUrl: './rejected-account-requests.component.html',
  styleUrls: ['./rejected-account-requests.component.css']
})
export class RejectedAccountRequestsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        ...
        //     {}
        //   )
        this.approverService.getAllRejectedAccountRequests().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
