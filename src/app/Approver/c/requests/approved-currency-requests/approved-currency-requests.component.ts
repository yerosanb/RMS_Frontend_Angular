...
@Component({
  selector: 'app-approved-currency-requests',
  templateUrl: './approved-currency-requests.component.html',
  styleUrls: ['./approved-currency-requests.component.css']
})
export class ApprovedCurrencyRequestsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    this.dtOptions = {
      ...
      ajax: (dataTablesParameters: any, callback: any) => {
        ...
        //     {}
        //   )
        this.approverService.getAllApprovedCurrencyRequests().subscribe(
          async (resp: any) => {
            if (resp != null) {
              console.log(
